          ...
          <div className="footer clearfix">
            <div className="row">
              <div className="column column_1_3">
                ...
                <p className="padding_top_bottom_25">
                  Maecenas mauris elementum, est morbi interdum cursus at elite
                  imperdiet libero. Proin odios dapibus integer an nulla augue
                  pharetra cursus.
                </p>
                <div className="row">
                ...
                <h4 className="box_header page_margin_top">
                ...
                <ul className="social_icons dark page_margin_top clearfix">
                  ...
                  <li>
                    <a title="" href="#" className="social_icon skype">
                      &nbsp;
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a title="" href="#" className="social_icon instagram">
                      &nbsp;
                    </a>
                  </li>
                  <li>
                    <a title="" href="#" className="social_icon pinterest">
                      &nbsp;
                    </a>
                  </li>
                </ul>
                    ...
                    <li className="post">
                      ...
                      <h5 className="with_number">
                        ...
                        <a
                          ...
                          href="post_gallery.html#comments_list"
                          title="2 comments"
                        >
            ...
            <div className="row page_margin_top_section">
              ...
              <div className="column column_1_4">
                <a className="scroll_top" href="#top" title="Scroll to top">
                  Top
                </a>
              </div>
            </div>
